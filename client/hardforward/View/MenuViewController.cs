using hardforward.Controller;
using hardforward.Model;
using hardforward.Properties;
using System;
...
namespace hardforward.View
{
    public class MenuViewController
    {
        ...
        private hardforwardController controller;
        ...
        public MenuViewController(hardforwardController controller)
        {
        ...
        void controller_FileReadyToOpen(object sender, hardforwardController.PathEventArgs e)
        {
