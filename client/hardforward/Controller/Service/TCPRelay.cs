...
using System.Net;
using hardforward.Encryption;
using hardforward.Model;
using hardforward.Controller.Strategy;
using System.Timers;

namespace hardforward.Controller
{

    class TCPRelay : Listener.Service
    {
        private hardforwardController _controller;
        ...
        public TCPRelay(hardforwardController controller)
        {
    ...
    class Handler
    {
        ...
        public hardforwardController controller;
